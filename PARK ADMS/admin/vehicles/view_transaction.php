...
if(isset($_GET['id']) && $_GET['id'] > 0){
	$transaction_qry = $conn->query("SELECT *, concat(FirstName, ' ', LastName) as customer, FirstName as first_name, LastName as last_name, Address, PhoneNumber, Email, DateOfVisit from `transaction_list` where id = '{$_GET['id']}' ");
		...
		<div class="card rounded-0 shadow">
			<div class="card-body">
				<div class="container-fluid" id="printout">
					...
					<div class="d-flex w-100">
						<div class="col-3 mb-0 border bg-gradient-secondary">First Name</div>
						<div class="col-9 mb-0 border"><?= isset($transaction['first_name']) ? $transaction['first_name'] : '' ?></div>
					</div>
					<div class="d-flex w-100">
						<div class="col-3 mb-0 border bg-gradient-secondary">Last Name</div>
						<div class="col-9 mb-0 border"><?= isset($transaction['last_name']) ? $transaction['last_name'] : '' ?></div>
					</div>
					<div class="d-flex w-100">
						<div class="col-3 mb-0 border bg-gradient-secondary">Address</div>
						<div class="col-9 mb-0 border"><?= isset($transaction['Address']) ? $transaction['Address'] : '' ?></div>
					</div>
					<div class="d-flex w-100">
						<div class="col-3 mb-0 border bg-gradient-secondary">Phone Number</div>
						<div class="col-9 mb-0 border"><?= isset($transaction['PhoneNumber']) ? $transaction['PhoneNumber'] : '' ?></div>
					</div>
					<div class="d-flex w-100">
						<div class="col-3 mb-0 border bg-gradient-secondary">Email</div>
						<div class="col-9 mb-0 border"><?= isset($transaction['Email']) ? $transaction['Email'] : '' ?></div>
					</div>
					<div class="d-flex w-100">
						<div class="col-3 mb-0 border bg-gradient-secondary">Date of Visit</div>
						<div class="col-9 mb-0 border"><?= isset($transaction['DateOfVisit']) ? date("M d, Y", strtotime($transaction['DateOfVisit'])) : '' ?></div>
					</div>
